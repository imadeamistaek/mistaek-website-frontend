...
<section class="section approach col-8" aria-labelledby="approach-heading">
	...
	<header>
		...
		<p class="body_text -medium -subtle col-5">Together, we create brands that not only stand out but resonate deeply with audiences. You can learn more about our detailed process on the homepage.</p>
		<a href="/" aria-label="Homepage">
			<p class="body_text -medium">Go to Homepage</p>
		</a>
	</header>
...
<style>
	...
	section.section.approach header p a {
		display: inline-flex;
	}
